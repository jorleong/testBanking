...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h2 class="w3-text-teal">Money Transfer Form</h2>
      	<p>How much would you like to transfer?</p>
		<form:form action="saveTransfer" method="POST" modelAttribute="transaction">
			<table>
			
				<tr>
					<td>Account Transfer From<form:input type="number" min="0" path="fromAcc"/>
<%-- 					<form:errors path="fromAcc" cssClass="error"/></td> --%>
				</tr>
				<tr><td>Account Transfer To<form:input type="number" min="0" path="toAcc"/></td>
<%-- 					<td><form:errors path="toAcc" cssClass="error"/></td> --%>
				</tr>
				<tr><td>Transfer Amount<form:input type="number" path="accTx"/></td>
